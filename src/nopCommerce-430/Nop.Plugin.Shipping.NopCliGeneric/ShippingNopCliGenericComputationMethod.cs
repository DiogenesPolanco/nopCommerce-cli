...
namespace Nop.Plugin.Shipping.NopCliGeneric
{
    ...
    public class ShippingNopCliGenericComputationMethod : BasePlugin, IShippingRateComputationMethod, IMiscPlugin
    {
        ...
        public GetShippingOptionResponse GetShippingOptions(GetShippingOptionRequest getShippingOptionRequest)
        {
            ...
            try
            {
                foreach (var rate in _ShippingNopCliGenericService.GetAllRates(getShippingOptionRequest))
                {
        ...
        {
            //settings
            _settingService.DeleteSetting<ShippingNopCliGenericSettings>();

            //locales
            _localizationService.DeletePluginLocaleResources("Enums.Nop.Plugin.Shipping.NopCliGeneric");
            _localizationService.DeletePluginLocaleResources("Plugins.Shipping.NopCliGeneric");
